...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, equals that blog', () => {
    ...
    expect(result).toEqual({"author": "Edsger W. Dijkstra", "title": "Go To Statement Considered Harmful", "likes": 5})
  })
...
describe('most blogs', () => {
  ...
  test('when list has multiple blogs, equals most blogs written by', () => {
...
describe('most likes', () => {
  ...
  test('when list has multiple blogs, equals most total likes', () => {
